...
public class CircularProgress extends View {
	...
	public CircularProgress(Context context, AttributeSet attrs,
		...
		a.recycle();
		mColors = new int[4];
		mColors[0] = context.getResources().getColor(R.color.blue_2);
		mColors[1] = context.getResources().getColor(R.color.blue_2);
		mColors[2] = context.getResources().getColor(R.color.blue_2);
		mColors[3] = context.getResources().getColor(R.color.blue_2);
	...
	public CircularProgress start() {
		if (isRunning()) {
			LogUtil.i("CircularProgress", "progress is run");
		} else {
			mRunning = true;
